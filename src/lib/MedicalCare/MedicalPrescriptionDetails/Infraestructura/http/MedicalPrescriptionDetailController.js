class MedicalPrescriptionDetailController {
  ...
  eliminar = async (req, res) => {
    ...
    res.json({ success: true, message: "Detalle desactivado correctamente" });
  };
}

module.exports = MedicalPrescriptionDetailController;